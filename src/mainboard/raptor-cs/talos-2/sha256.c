...
// Probably not necessary, used in s0/1 and e0/1 only
// vspltisw  vrX, -shift	// vrlw uses unsigned 5 bits, but that's OK
// vrlw      ror32[0-3], word[0-3], vrX
...
// vshasigmaw	e0[0-3], state[0-3], 1, 0 // last operand allows for mixed e0 and e1
// vshasigmaw	e1[0-3], state[0-3], 1, f
// vshasigmaw	s0[0-3], state[0-3], 0, 0
// vshasigmaw	s1[0-3], state[0-3], 0, f
