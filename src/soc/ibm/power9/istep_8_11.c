...
static void p9_npu_scom(void)
{

	scom_and(0x5011000, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011003, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011010, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501101A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501101B, PPC_BIT(0));

	scom_and(0x5011030, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011033, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011040, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501104A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501104B, PPC_BIT(0));

	scom_and(0x5011060, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011063, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011070, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501107A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501107B, PPC_BIT(0));

	scom_and(0x5011090, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011093, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x50110A0, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x50110AA, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x50110AB, PPC_BIT(0));

	scom_and_or(0x50110C0, ~(PPC_BIT(4) | PPC_BITMASK(16, 47)), 0x10C10C440000);

	scom_and(0x5011120, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_or(0x5011200, PPC_BITMASK(6, 7));
	scom_and_or(0x5011203, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011210, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501121A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501121B, PPC_BIT(0));

	scom_and(0x5011230, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011233, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011240, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501124A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501124B, PPC_BIT(0));

	scom_and(0x5011260, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011263, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011270, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501127A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501127B, PPC_BIT(0));

	scom_and(0x5011290, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011293, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x50112A0, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x50112AA, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x50112C0, PPC_BIT(0));

	scom_and(0x50112C0, ~PPC_BIT(4));
	scom_and(0x5011400, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011403, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011410, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501141A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501141B, PPC_BIT(0));

	scom_and(0x5011430, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011433, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011440, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501144A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501144B, PPC_BIT(0));

	scom_and(0x5011460, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_and_or(0x5011463, ~PPC_BITMASK(26, 37), PPC_BIT(61) | PPC_BIT(37));
	scom_and_or(0x5011470, 0xFF00FF00FFFFFFFF, 0x4B006600000000);
	scom_or(0x501147A, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x501147B, PPC_BIT(0));

	scom_and(0x5011490, PPC_BIT(4) | PPC_BITMASK(6, 7));
	scom_or(0x5011493, PPC_BIT(26) | PPC_BIT(32));
	scom_and_or(0x50114A0, 0xFFFFFF00FFFFFFFF, 0x6600000000);
	scom_or(0x50114AA, PPC_BITMASK(0, 1) | PPC_BIT(40));
	scom_or(0x50114AB, PPC_BIT(0));

	scom_and(0x50114C0, ~PPC_BIT(4));
	scom_and(0x5011683, ~PPC_BITMASK(0, 6));
	write_scom(0x5013C03, 0xFFFFFFFFFFFFFFFF);
	write_scom(0x5013C43, 0xFFFFFFFFFFFFFFFF);
	write_scom(0x5013C83, 0xFFFFFFFFFFFFFFFF);
}

static void p9_npu_scominit(void)
{
	if(ATTR_PROC_NPU_REGION_ENABLED)
	{
		p9_npu_scom();
		scom_or(PU_NPU_SM2_XTS_ATRMISS_POST_P9NDD1, PU_NPU_SM2_XTS_ATRMISS_ENA);
		scom_or(PERV_ROOT_CTRL6_SCOM, PPC_BITMASK(20, 23));
	}
}
...
static void p9_obus_scom(chiplet_id_t obusTarget)
{
	for(size_t id = 0; id < 0x17; ++id)
	{
		...
		if(id == 0x3 || id == 0x5 || id == 0x9) {
			scom_and_or_for_chiplet(obusTarget, 0x8000300009010C3F | (id << ID_OFFSET), ~PPC_BITMASK(48, 56), 0xA500);
		} else {
		...
		if(id == 0x3) {
			scom_and_or_for_chiplet(obusTarget, 0x8000C80009010C3F | (id << ID_OFFSET), ~PPC_BITMASK(48, 56), 0x6780);
		} else if(id == 0x5) {
			scom_and_or_for_chiplet(obusTarget, 0x8000C80009010C3F | (id << ID_OFFSET), ~PPC_BITMASK(48, 56), 0x9500);
		} else if(id == 0x9) {
			scom_and_or_for_chiplet(obusTarget, 0x8000C80009010C3F | (id << ID_OFFSET), ~PPC_BITMASK(48, 56), 0x9710);
		} else {
...
static void p9_psi_scom(void)
{
	...
	scom_and_or(0x5012903, 0x00000007FFFFFFFF, 0x7E040DFull << 35);
	scom_and(0x5012906, ~PPC_BITMASK(0, 29));
	scom_and_or(0x5012907, 0x00000007FFFFFFFF, 0x18050020ull << 35);
...
static void p9_io_obus_firmask_save(void)
{
	...
	for (size_t obus_index = 0; obus_index < ARRAY_SIZE(obus_chiplets); obus_index++)
	{
		...
		for(size_t bit_index = PB_IOOL_FIR_MASK_REG_FIR_LINK0_NO_SPARE_MASK;
			...
			++bit_index)
		{
			if(((action0Buffer & PPC_BIT(bit_index)) == 0) && (action1Buffer & PPC_BIT(bit_index)))
			{
				firMaskReg |= PPC_BIT(bit_index);
			}
		}
...
static void p9_cxa_scom(chiplet_id_t capp_chiplet)
{
	...
	// (1, 1) = Machine check.
	scom_and_for_chiplet(capp_chiplet, 0x2010806, ~PPC_BITMASK(0, 53));
	...
	scom_and_for_chiplet(capp_chiplet, 0x2010819, ~PPC_BITMASK(4, 7));
...
static void p9_nx_scom(void)
{
	...
	// [12:15] HANG_SHM_SCALE: Determines how many data polls must be detected
	// to indicate a shim poll to the logic.
	// A shim poll is created by the CQ logic to detect hangs of SMs while
	// waiting on exchanges with the shim logic.
	// [16:19] ERAT_DATA_POLL_SCALE: Determines how many data polls must
	// be detected to indicate a data poll to the ERAT logic.
	scom_and_or(
		0x20110A8,
		~PPC_BITMASK(4, 19),
...
{
	for(size_t mcs_index = 0; mcs_index < MCS_PER_PROC; ++mcs_index)
	{
		p9n_mcs_scom(mcs_ids[mcs_index]);
	}
	...
	for(size_t obus_index = 0; obus_index < ARRAY_SIZE(obus_chiplets); ++obus_index)
	{
		...
		p9_fbc_ioo_dl_scom(obus_chiplets[obus_index]);
	}
