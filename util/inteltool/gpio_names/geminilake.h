...
static const char *const glk_group_northwest_names[] = {
	...
	"*GPIO_40",		"N/A",				"N/A",				"CNV_BT_HOST_WAKE_N","N/A",					"NA",			"N/A",
	"*GPIO_41",		"N/A",				"N/A",				"CNV_GNSS_HOST_WAKEN","N/A",				"NA",			"N/A",
...
static const struct gpio_group glk_group_northwest = {
	...
	.pad_count	= ARRAY_SIZE(glk_group_northwest_names) / 4,
	.func_count	= 4,
...
static const struct gpio_group glk_group_west = {
	.display	= "-------- GPIO Group West -------",
	.pad_count	= ARRAY_SIZE(glk_group_west_names) / 4,
	.func_count	= 4,
	.pad_names	= glk_group_west_names,
};

static const struct gpio_group *const glk_community_west_groups[] = {
	&glk_group_west,
};

static const struct gpio_community glk_community_west = {
	.name		= "------ GPIO Community West -----",
	.pcr_port_id	= 0xc7,
	.group_count	= ARRAY_SIZE(glk_community_west_groups),
	.groups		= glk_community_west_groups,
};

static const struct gpio_group glk_group_southwest = {
	.display	= "----- GPIO Group SouthWest -----",
	.pad_count	= ARRAY_SIZE(glk_group_southwest_names) / 3,
	.func_count	= 3,
	.pad_names	= glk_group_southwest_names,
};

static const struct gpio_group *const glk_community_southwest_groups[] = {
	&glk_group_southwest,
};

static const struct gpio_community glk_community_southwest = {
	.name		= "--- GPIO Community SouthWest ---",
	.pcr_port_id	= 0xc0,
	.group_count	= ARRAY_SIZE(glk_community_southwest_groups),
	.groups		= glk_community_southwest_groups,
};

static const struct gpio_community *const glk_communities[] = {
	&glk_community_north, &glk_community_northwest,
	&glk_community_west, &glk_community_southwest,
};
